		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto:abhishekkr6416@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/Abhishek6416'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/kumarabhishekh/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Abhishekh Kumar
			</div>
		</footer>
	);
};
