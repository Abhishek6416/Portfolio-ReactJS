		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						{/* I am a Full Stack Developer based in Asansol,West Bengal. I build
						things for web. */}

						I am a Full Stack Developer, passionate about building digital products that improve everyday experience for people
                     
					</h1>
					<div className={styles.btn}>
						
						<a href='https://drive.google.com/drive/folders/1vn7E8BHafA2oCJFEtzoSPXMh_0vuDNVZ' target='_blank' rel='noopener noreferrer'>
							<Button
								text={
				...
				>
					...
					{/* <img
					     src="https://avatars.githubusercontent.com/u/92006074?v=4"
